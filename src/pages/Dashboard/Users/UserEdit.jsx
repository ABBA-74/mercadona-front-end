          ...
          <>
            ...
            <div className='section-user-edit-main mb-5 ps-0 ps-md-5'>
              <div className='row gx-5 justify-content-between'>
                ...
                <div className='col-12 col-lg-5 col-xl-4 section-user-edit-overview d-flex flex-column justify-content-between gx-0 gx-lg-5'>
                  <div className='overview-wrapper-top rounded border mb-5 mb-lg-0'>
